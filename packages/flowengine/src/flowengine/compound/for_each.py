...
from flowengine.compound.protocol import CompoundNodeType, Region
from flowengine.execution.events import (
    NodeCompleteEvent,
    NodeProgressEvent,
    NodeStartEvent,
)
from flowengine.execution.results import extract_output, filter_skipped, normalize_result
from flowengine.graph.regions import discover_for_each_regions
...
def _execute_subgraph(
    ...
    from flowengine.execution.engine import _dispatch_node
