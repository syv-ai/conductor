...
from flowengine.metadata import InputMetadata, OutputMetadata
from flowengine.registry.definition import NodeDefinition
from flowengine.types import (
    RESULT_KEY,
    OUTPUT_PREFIX,
    NodeCategory,
    ResultFormat,
...
from flowengine.validation import _extract_type_string, _is_injectable, create_validation_model
from flowengine.widgets import Output, Widget
...
class NodeRegistry:
    ...
    def discover(self, package_name: str) -> int:
        ...
        from flowengine.registry.discovery import discover_nodes
