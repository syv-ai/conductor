# FlowEngine — Design Specification
...
**Dependency rule:** No module in `flowengine` imports from the host application. No FastAPI, SQLModel, or app-specific imports.
...
from flowengine import NodeRegistry, compile, execute
...
| Concern | FlowEngine | Host Application |
|---|---|---|
...
| Current (AKA Flows) | New (FlowEngine) | Change Level |
|---|---|---|
| `services/flows/types.py` | `flowengine/types.py` | Copy, remove app-specific types |
| `services/flows/widgets.py` | `flowengine/widgets.py` | Copy unchanged |
| `services/flows/metadata.py` | `flowengine/metadata.py` | Copy unchanged |
| `services/flows/validation.py` | `flowengine/validation.py` | Copy unchanged |
| `services/flows/registry.py` | `flowengine/registry/__init__.py` | Refactor: split class, remove legacy dicts |
| `services/flows/introspection.py` | `flowengine/registry/schema.py` | Refactor: work from NodeDefinition |
| `execution/executor.py` (1015 lines) | `flowengine/execution/engine.py` (~150 lines) | Rewrite |
| `execution/context.py` | `flowengine/execution/state.py` | Replace with FlowRunState |
| `execution/graph.py` | `flowengine/graph/topology.py` + `regions.py` | Split |
| `execution/inputs.py` | `flowengine/execution/resolver.py` | Copy, adjust imports |
| `execution/results.py` | `flowengine/execution/results.py` | Copy unchanged |
| `execution/app_node.py` | Host app's `AppNodeResolver` | Host-side code |
| `nodes/loop.py` (prepare/collect) | `flowengine/compound/for_each.py` | Move helpers |
...
1. Create `flowengine/` package with the structure above.
...
10. Update node files to import from `flowengine` instead of `app.services.flows`.
